...
<https://ludii.games/identifier.php?Id=DLP.Games.3> a schema:Game ; # https://ludii.games/details.php?keyword=Senet
    ...
    schema:hasEndTime "-0029"^^xsd:gYear ; #Date, PeriodId for date range
...
:_MainRuleset a schema:additionalPropery ;
    ...
    ludii:ruleset "These are the rules of this ruleset, described with reference to the main ruleset for this game" ; #Ruleset
